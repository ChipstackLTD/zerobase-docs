...
Bạn có thể sử dụng code mẫu để nháy LED trên Zerobase 2 bằng cách vào **File > Examples > Zerobase 2 Example > Blink > example > Blink**.

![blink-example](https://cdn.chipstack.vn/zerobase2/quickstart/blink-example.png)
