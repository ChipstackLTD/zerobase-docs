...
![Các phiên bản Zerobase](https://cdn.chipstack.vn/zerobase-versions/zerobase-series-v2.png)

## So sánh giữa các phiên bản
|           | Zerobase  | Zerobase 2 | Zerobase 2W |
|-----------|-----------|------------|-------------|
| MCU | CH32V003F4P6 | CH32V203C8T6 | CH32V203C8T6 |
| WiFi Chip | :fas fa-times-square fa-fw red: | :fas fa-times-square fa-fw red: | ESP8285 |
| CPU | RISC-V | RISC-V | RISC-V |
| Điện áp MCU | 5V | 3V3 | 3V3 |
| Xung nhịp | 48 MHz | 144 MHz | 144 MHz |
| Bộ nhớ | 2 KB | 20 KB | 20 KB |
| Flash | 16 KB | 64 KB | 64 KB |
| Nguồn cấp | Qua USB, chân 5V | Qua USB, chân 5V | Qua USB, chân 5V |
| Điện áp IO | 5V | 3.3V | 3.3V |
...
| Kích thước | 43.18 mm x 17.78 mm | 43.18 mm x 17.78 mm | 43.18 mm x 17.78 mm |
| Kiểu chân | Through hole | Through hole | Through hole |
| Tổng số chân | 30 | 30 | 30 |
| Số chân Digital | 15 | 22 | 22 |
| Số chân Analog | 4 | 6 | 6 | 
...
| USB | 0 | 2 | 2 |
| CAN | 0 | 1 | 1 |
| WiFi 2.4GHz | :fas fa-times-square fa-fw red: | :fas fa-times-square fa-fw red: | :fas fa-square-check fa-fw blue: |
